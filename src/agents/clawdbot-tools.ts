...
import { createProjectContextTool } from "./tools/project-context-tool.js";
import { createClaudeCodeStartTool } from "./tools/claude-code-start-tool.js";
...
export function createClawdbotTools(options?: {
  ...
  const tools: AnyAgentTool[] = [
    ...
    createClaudeCodeStartTool({
      dyDoSessionId: options?.agentSessionKey,
    }),
